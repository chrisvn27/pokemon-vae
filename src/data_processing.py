...
def convert_to_dataloader_train_and_test(batch_size = batch_size,transform = transform):
    ...
    dataset_records_train, dataset_records_val, dataset_records_test = random_split(dataset_records, [0.8, 0.1, 0.1])
    dataloader_train = DataLoader(dataset_records_train, batch_size= batch_size, shuffle= True)
    dataloader_val = DataLoader(dataset_records_val, batch_size= batch_size)
...
if __name__ == "__main__":
    ...
    train_dataloader, val_dataloader, test_dataloader = convert_to_dataloader_train_and_test()
