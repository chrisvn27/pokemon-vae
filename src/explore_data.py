...
Explores the Pokemon sprite dataset before VAE training:
- Enumerates front-facing sprite PNGs (normal + shiny)
- Parses species/dex/variant metadata from folder names
- Cross-checks parsed species against pokedex.csv
- Validates image dimensions, color mode, and file integrity

Expects: data/pokemon_images/sprites/ and data/pokemon_images/pokedex.csv
"""
